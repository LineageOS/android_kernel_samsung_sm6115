...
#define logprint(fmt, args...) printf(fmt "\n", ##args)
...
#define FSM_DRV_NAME     "fs18xx"
#define FSM_FW_NAME      "fs18xx.fsm"

/* VERSION INFORMATION */
#define FSM_CODE_VERSION "v3.0.2"
#define FSM_CODE_DATE    "20200620-1409"
#define FSM_GIT_BRANCH   "Wingtech-N19"
#define FSM_GIT_COMMIT   "bc788cfe"
